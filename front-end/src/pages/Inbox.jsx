...
// Página responsável por exibir a caixa de entrada de mensagens. O backend usa /api/inbox/mensagens.
function Inbox() {
  ...
  const messages = [
    {
      author: 'Francisco',
      channel: 'YouTube',
      preview: 'Vimos o seu último comentário e já estamos a preparar a follow-up.',
    },
    {
      author: 'Pedro',
      channel: 'Instagram',
      preview: 'Recebemos uma pergunta sobre a próxima live de lançamento.',
    },
    {
      author: 'Nina',
      channel: 'Twitch',
      preview: 'O chat está muito ativo e pedem mais conteúdo exclusivo.',
    },
  ]
      ...
      <header className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Esta página representa o fluxo de mensagens vindas das redes sociais e da gestão de comentários.
          </p>
        </div>
      </header>
